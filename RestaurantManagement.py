...
def recibo():
    ...
    fecha_recibo = f'{fecha.year}/{fecha.month}/{fecha.day} - {fecha.hour}:{fecha.minute}        '
...
def guardar():
    ...
    archivo.close()
    messagebox.showinfo('Información', 'Su recibo ha sido guardado exitosamente')
...
# Etiqueta Titulo
etiqueta_titulo = Label(panel_superior,text='Sitema de facturación', fg='azure4',
...
# Lista de Productos
lista_comidas = ['Pollo', 'Salmón', 'Carne de cerdo', 'Carne de res', 'Pizza', 'Hambuerguesa', 'Sushi', 'Hot dogs']
lista_bebidas = ['Agua', 'Soda', 'Jugos', 'Gaseosas', 'Vino 1', 'Vino 2', 'Cerveza 1', 'Cerveza 2']
lista_postres = ['Helado', 'Fruta', 'Brownies', 'Flan', 'Napoleón', 'Pastel', 'Chiskake', 'Gelatina con crema']
...
for comida in lista_comidas:
    ...
    comida = Checkbutton(panel_comidas, text=comida.title(), font=('Dosis', 16, 'bold'),
...
for bebida in lista_bebidas:
    ...
    bebida = Checkbutton(panel_bebidas, text=bebida.title(), font=('Dosis', 16, 'bold'),
...
for postre in lista_postres:
    ...
    postre = Checkbutton(panel_postres, text=postre.title(), font=('Dosis', 16, 'bold'),
...
# Botones
botones = ['Total', 'Recibo', 'Guardar', 'Restablecer']
botones_creados = []
